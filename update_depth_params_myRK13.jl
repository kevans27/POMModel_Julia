...
function update_depth_params_myRK13(z, r, sherwood_nu)
    iAttach = zeros(2)
    ...
    iAttach[2]=4*π*motility*r*sherwood_nu/100*free_cell_function*newAttachedCells*60*24; #cells/mins*24*60=cells/day, added to bopa2 pool
    
    return iAttach, TempFunction
end